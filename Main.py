...
tess_path = '/Users/yashvaishnav/College-project/.venv/bin/pytesseract' 
view_mode = 1
source = 0
crop = [100, 100]
language = "en"
"""OCR.ocr_stream(view_mode=view_mode, source=source, crop=crop, language=language)
output_filename = "scanned_text_" + datetime.now().strftime("%Y-%m-%d_%H-%M-%S") + ".txt"  # Generate timestamped filename
OCR.ocr_stream(view_mode=view_mode, source=source, crop=crop, language=language, output_filename=output_filename)
U"""
